<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-200">
            ...
            <?php echo e(__("Update your account's profile information, email address, and profile picture.")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'profile_picture','value' => __('Foto Profil')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'profile_picture','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Foto Profil'))]); ?>
...
<?php endif; ?>
            ...
            <img 
                ...
                src="<?php echo e($user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://via.placeholder.com/100?text=Pilih Foto'); ?>" 
                alt="Foto Profil" 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'profile_picture_input','name' => 'profile_picture','type' => 'file','class' => 'mt-1 block w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'profile_picture_input','name' => 'profile_picture','type' => 'file','class' => 'mt-1 block w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</section><?php /**PATH C:\xampp\htdocs\Rinja\rinja\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>